...
public class HttpRestRequest extends AsyncTask<String, String, String> {
    ...
    public HttpRestRequest(RestResponse delegate, String requestDescription, String requestType, HashMap<String, String> requestHeader) {
